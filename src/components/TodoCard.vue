<template>
  <div
    :class="{ 'rotate-1': isGrabbed, 'border-l-8 border-red-500': todo.isDone }"
    @mouseleave="isGrabbed = false"
    @mouseenter="isGrabbed = true"
    class="bg-white dark:bg-slate-600 my-2 p-3 rounded-lg shadow-lg cursor-pointer"
  >
