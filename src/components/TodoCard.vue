<template>
<div class="bg-white dark:bg-slate-600 my-2 p-3 rounded-lg shadow-lg cursor-pointer ">
    <div class="text-slate-600 dark:text-white font-bold text-md mx-auto">
        <div class="flex justify-between items-center">
        <div>Sofware engineering</div>
        <div class="flex">
    ...
    <p class="text-slate-600 dark:text-white font-meduim mt-3">
        Simple, flexible, get a clear view of who’s doing what and what needs to get done. 
    </p>
</div>
</template>
