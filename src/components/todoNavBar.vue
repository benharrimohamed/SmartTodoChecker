<template>
<div class="shrink-1 flex mt-2 space-x-4 items-center border border-red-400">
    <div @click=handleAllTodos class="flex justify-between items-center cursor-pointer bg-cyan-500 px-2 py-1 text-white rounded-full shadow-lg">
        All  
    ...
    <div @click=handleWorkTodos class="flex justify-between items-center cursor-pointer bg-green-500 px-2 py-1 text-white rounded-full shadow-lg">
        Work
        <span class="ml-1 inline-flex items-center justify-center w-4 h-4 text-xs font-semibold text-green-800 bg-green-200 rounded-full">{{ workCount }}</span>
    </div>
    <div @click=handleStudieTodos class="flex justify-between items-center cursor-pointer bg-purple-500 px-2 py-1 text-white rounded-full shadow-lg">
        Studies
        <span class="ml-1 inline-flex items-center justify-center w-4 h-4 text-xs font-semibold text-purple-800 bg-purple-200 rounded-full">{{ studiesCount }}</span>
    </div>
